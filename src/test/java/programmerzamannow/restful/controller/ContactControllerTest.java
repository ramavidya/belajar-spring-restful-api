...
class ContactControllerTest {
    ...
    void createContactSuccess() throws Exception{
        ...
        mockMvc.perform(
            ...
            assertEquals("123456789101", response.getData().getPhone());
    ...
    void updateContactSuccess() throws Exception{
        ...
        request.setPhone("1234567891012");
