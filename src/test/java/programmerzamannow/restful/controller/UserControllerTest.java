...
class UserControllerTest {
    ...
    @Test
    void testReqisterSuccess() throws Exception {
    ...
    @Test
    void testReqisterBadRequest() throws Exception {
        RegisterUserRequest request = new RegisterUserRequest();
        request.setUsername("");
        request.setPassword("");
        request.setName("");
    ...
    @Test
    void testReqisterDuplicate() throws Exception {
        User user = new User();
    ...
    @Test
    void getUserUnauthoried() throws Exception {
        mockMvc.perform(
    ...
    @Test
    void getUserUnauthoriedTokenNotSend() throws Exception {
        mockMvc.perform(
                get("/api/users/current")
                        .accept(MediaType.APPLICATION_JSON)
        ).andExpectAll(
