...
public class ContactController {
    ...
    public WebResponse<ContactResponse> create(User user, @RequestBody CreateContactRequest request){
        ContactResponse contactRespone = contactService.create(user, request);
        return WebResponse.<ContactResponse>builder().data(contactRespone).build();
    }
    ...
    public WebResponse<ContactResponse> update(User user, @RequestBody UpdateContactRequest request,
        ...
        ContactResponse contactRespone = contactService.update(user, request);
        return WebResponse.<ContactResponse>builder().data(contactRespone).build();
    }
